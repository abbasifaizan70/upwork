...
<head>
    ...
    <title>Инструкция для пользователей портала</title>
	...
	<div class="sidebar">
		<div class="wrap">
			<ul itemscope itemtype="http://schema.org/BreadcrumbList">
				...
				<li><span>Инструкция для пользователей портала</span></li>
			</ul>
		</div>
	</div>
	<div class="catalog-block">
		<div class="wrap">
			<div class="cb-title">Инструкция для пользователей портала</div>
			<div class="cb-sep"><img src="images/b2-sep.png" alt=""></div>
			<div class="on-box">
				<p><strong>1. РЕГИСТРАЦИЯ НОВОГО УЧАСТНИКА ПОРТАЛА</strong></p>

<p><strong>Внимание</strong>! Регистрировать можно только новые страницы, т.е. если Ваша страница еще не создана. Если ранее страница существовала, и Вы не получили свой логин-пароль, обратитесь в редакцию сайта, указав название страницы и раздел.</p>

<p>Регистрация новых участников портала на сайте - <strong>бесплатно</strong>:</p>

<p>Шаг 1. Ознакомиться с&nbsp;<a href="/polzovatelskoe_soglashenie" target="_blank"><u>правилами сайта</u></a>&nbsp;и принять их.&nbsp;</p>

<p>Шаг 2. Зарегистрироваться на сайте (ссылка на форму регистрации в верхнем меню сайта). После регистрации Вам на указанный e-mail адрес придет письмо подтверждения, ознакомьтесь с ним, пожалуйста.</p>

<p>Шаг 3. Зайти в Личный кабинет -&gt; и нажать кнопку &laquo;Добавить анкету&raquo; -&gt; заполнить все поля формы максимально подробно, выбрать аватар,&nbsp; добавить фото галерею и видео ролики,&nbsp;затем нажать кнопку &laquo;Сохранить анкету&raquo;. После проверки модератором анкета будет опубликована на сайте.</p>

<p><em>Вы можете вносить изменения в&nbsp;свою анкету бесплатно.&nbsp;</em></p>

<p>В рамках одного Личного кабинета допускается создание нескольких анкет в разных жанрах.</p>

<p><strong>Примечание!</strong> Мы постарались сделать регистрацию на сайте максимально простой и доступной каждому пользователю. Но, если у вас все-таки возникнут проблемы, свяжитесь с нами, мы поможем.</p>

<p>&nbsp;</p>

<p><strong>2.ПОЗИЦИОНИРОВАНИЕ АНКЕТЫ НА САЙТЕ</strong></p>

<p>Шаг 1. Пополнить личный счет своего профиля одним из доступных способов, нажав кнопку <em>&laquo;Пополнить&raquo; в личном кабинете</em>.<!-- Подробная инструкция по пополнению личного счета посредством терминалов QIWI <u>как пополнить личный счет через терминал </u><u>Qiwi</u>.--></p>

<p>Шаг 2. В списке &laquo;Мои анкеты&raquo; найдите необходимую анкету и нажмите кнопку&nbsp;&laquo;Платные функции&raquo;. Вам откроется окно с выбором действия: показать контакты, поднять анкету наверх, выделить анкету цветом или увеличить лимит на медиа файлы. Активировать ффункцию возможно в том случае, если баланс вашего личного кабинета равняется или больше стоимости выбранной услуги.</p>

<p>Шаг 3. После выбора определенного действия с личного счета будет списана соответствующая сумма.</p>

<p>&nbsp;</p>

<p><strong>3. РЕДАКТИРОВАНИЕ АНКЕТЫ</strong></p>
<!--<p>Шаг 1. Пополнить личный счет через терминалы Qiwi или наличными представителям компании. Подробная инструкция по пополнению личного счета посредством терминалов QIWI <u>как пополнить личный счет через терминал </u><u>Qiwi</u>.</p>-->

<p>Шаг 1. Зайти в Личный кабинет, использовав логин и пароль.</p>

<p>Шаг 2. В списке &laquo;Мои анкеты&raquo; нажмите кнопку &laquo;Редактировать&raquo; напротив необходимой анкеты.</p>

<p>Шаг 3. В открывшейся странице внесите изменения в необходимых полях, а также вы можете изменить содержание медиа (фото / видео / аудио).</p>

<p>Шаг 4. После внесения необходимых изменений, нажмите кнопку &laquo;Сохранить анкету&raquo;. После проверки модератором новые данные будут отражены в Вашей анкете.</p>

<p><strong>Примечание!</strong> Будьте внимательны! После нажатия кнопки &laquo;Сохранить анкету&raquo; сеанс редактирования будет завершен.<!-- Для повторного редактирования данных необходимо будет вновь оплатить сеанс редактирования.</p>--></p>
